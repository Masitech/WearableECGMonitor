...
BufferedSerial::BufferedSerial(PinName tx, PinName rx, uint32_t baudRate, uint32_t buf_size, uint32_t tx_multiple, const char* name)
    : RawSerial(tx, rx, baudRate) , _rxbuf(buf_size), _txbuf((uint32_t)(tx_multiple*buf_size))
{
